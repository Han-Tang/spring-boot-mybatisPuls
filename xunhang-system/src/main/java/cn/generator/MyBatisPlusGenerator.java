...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\自动生成代码");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[] { "InfoProduct","ProductSale","ProductProduce","ProductPurch","InfoFile","test"}); // 需要生成的表
        // 排除生成的表
        ...
        pc.setParent(null);
        pc.setEntity("cn.xunhang.system.entity");
        pc.setMapper("cn.xunhang.system.dao");
        pc.setXml("cn.xunhang.system.dao");
        pc.setService("cn.xunhang.system.service");
        pc.setServiceImpl("cn.xunhang.system.service.impl");
        pc.setController("cn.xunhang.system.controller");
